...
dependencies, install Sessions in ``editable`` mode. For example:
...
Sessions unit tests are found in the ``tests/`` directory and are
...
Sessions documentation is stored in the ``docs/`` directory. It is
